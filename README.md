...
- rd, rs1, rs2 pueden ser: cualquier numero de 4 bits (pero la instruction es de 32 bits, por lo que usamos el formato 0XXXX), estos no tienen restricciones ya que cualquier combinación de registros es válida para instrucciones tipo R segun el ISA.
